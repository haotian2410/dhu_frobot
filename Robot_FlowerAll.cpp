...
//static double camera_rate[4][2] = { {600, 1.15}, {400, 0.836}, { 150, 0.45 } ,{0, 0.223} };// 相机在不同绝对距离下对应图像的像素长度比（mm, mm/px)
////=========================================================================/=================================================/
//static Size photo = Size(1280.0, 800.0);									// 相机拍摄图像规格(px)
//static double handsize = 114;												// 夹爪可夹取的范围(mm)
//static double horizon = 436;												// 从环境感知出的桌面位置(mm)
...
////=========================================================================/=================================================/
//static vector<double> pose_init = { 600, -250, camera_rate[0][0] + horizon, 180, 0, -130 };					// 相机初始拍摄位置
