...
with open(r"C:\Program\Project\Robot\Data\Prompt\quest.txt", "r", encoding="utf-8") as t:
    system_quest = t.read()
...
output_file_path = "C:/Program/Project/Robot/Result/VLM/flower.txt"
# 将结果保存到txt文件
try:
